...
class ProgressBar(tqdm):
    ...
    def format_dict(self):
        ...
        remaining_seconds_this_epoch = remaining_iterations / (d.get('rate') or 1.)
        ...
        d['estimated_remaining_seconds'] = remaining_seconds_this_epoch + self.remaining_epochs * d['estimated_time_per_epoch']
        return d
