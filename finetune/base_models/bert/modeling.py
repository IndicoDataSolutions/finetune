        ...
        with tf.variable_scope("output"):
          ...
          if adapter_size is not None:
            with tf.variable_scope("attention_adapter"):
              attention_output = adapter(attention_output, adapter_size, hidden_size, hidden_dropout_prob!=0) # dropout prob is set to 0 above if not training, so we can use it to infer the 'train' argument for adapters
