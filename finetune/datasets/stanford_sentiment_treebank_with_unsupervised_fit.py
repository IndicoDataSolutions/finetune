...
if __name__ == "__main__":
    ...
    pre_train_generator = lambda: iter(
        StanfordSentimentTreebank(nrows=5000).dataframe.Text.values
    )
    model = Classifier(
        n_epochs=3, batch_size=2, lr_warmup=0.1, tensorboard_folder=".tensorboard"
    )
