...
if __name__ == "__main__":
    ...
    model = Classifier(verbose=True, summarize_grads=True, n_epochs=2, val_size=0.01, val_interval=10, visible_gpus=[], tensorboard_folder='.tensorboard', lm_loss_coef=0.5)
