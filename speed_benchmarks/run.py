...
if __name__ == "__main__":
    ...
    for optimize_for in ["speed", "accuracy", "predict_speed"]:
        ...
        clf_train, clf_infer = benchmark_classification(
            config, runs=average_over_n_runs
        )
        ...
        multi_seq_train, multi_seq_infer = benchmark_multi_sequence(
            config, runs=average_over_n_runs
        )
        output.append(
            ["Multi Sequence", optimize_for, multi_seq_train, multi_seq_infer]
        )
